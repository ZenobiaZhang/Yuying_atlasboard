/**
 * Test file for Job: postmanJob
 */

var assert = require ('assert');
var postmanJob_SUT = require('../postmanJob');

var mockedConfig, mockedDependencies;

describe ('postmanJob test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      postmanJob_SUT.onRun(config, mockedDependencies, function(err, data){
